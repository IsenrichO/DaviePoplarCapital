    ...
    return (
      <div id="centerFill" style={{ top: '17.5%', transform: 'none' }}>
        ...
        <div style={{ background: '#FFF', width: '100%' }}>
          <p className="about_Par" style={{ margin: '5% 0' }}>Davie Poplar Capital (DPC) is a Raleigh, NC based private investment firm that acquires, operates, and grows established private businesses.  We make controlling investments in small and mid-sized profitable companies that are based in or relocatable to North and South Carolina.
